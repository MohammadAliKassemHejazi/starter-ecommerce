...
export const mockDatabase = {
  ...
  categories: [
    { id: "cat-elec", name: "Electronics & Tech", description: "Cutting-edge devices and smart gadgets.", userId: "user-admin1", createdAt: d(400), updatedAt: d(400) },
    { id: "cat-fash", name: "Apparel & Fashion", description: "Trendy clothing for all seasons.", userId: "user-admin1", createdAt: d(400), updatedAt: d(400) },
    { id: "cat-home", name: "Home & Living", description: "Furniture, decor, and kitchenware.", userId: "user-admin1", createdAt: d(380), updatedAt: d(380) }
  ] as ICategories[],
  ...
  stores: [
    { id: "store-tech", name: "Tech Haven", description: "Your one-stop shop for premium electronics, offering the latest smartphones, audio gear, and laptops from top brands.", imgUrl: "https://images.unsplash.com/photo-1531297172864-df2240c9b1b1", categoryId: "cat-elec", userId: "user-storeowner1", isActive: true, createdAt: d(340), updatedAt: d(340), metaTitle: "Tech Haven Store", metaDescription: "Buy electronics online" },
    { id: "store-fash", name: "Fashion Hub", description: "Curated styles for the modern individual. We source high-quality fabrics and unique designs from global creators.", imgUrl: "https://images.unsplash.com/photo-1441984904996-e0b6ba687e04", categoryId: "cat-fash", userId: "user-storeowner2", isActive: true, createdAt: d(290), updatedAt: d(290), metaTitle: "Fashion Hub Boutique", metaDescription: "Trendy clothing" },
    { id: "store-home", name: "Cozy Living", description: "Transform your house into a home with our exquisite collection of decor and furniture.", imgUrl: "https://images.unsplash.com/photo-1618220179428-22790b46a013", categoryId: "cat-home", userId: "user-storeowner1", isActive: false, createdAt: d(100), updatedAt: d(50) } // Inactive store
  ...
  products: [
    { id: "prod-101", name: "Quantum X Pro Smartphone", description: "The fastest processor on the market with a revolutionary AI camera system. 256GB storage, 12GB RAM, OLED display.", price: 1099.00, originalPrice: 1299.00, discount: 200, stockQuantity: 150, isActive: true, categoryId: "cat-elec", subcategoryId: "sub-phones", storeId: "store-tech", thumbnail: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9", ratings: 4.8, commentsCount: 45, createdAt: d(100) },
    { id: "prod-102", name: "Noise-Cancelling Earbuds Z", description: "Immersive audio experience with active noise cancellation and 30-hour battery life. Water-resistant.", price: 149.99, originalPrice: 149.99, discount: 0, stockQuantity: 300, isActive: true, categoryId: "cat-elec", storeId: "store-tech", thumbnail: "https://images.unsplash.com/photo-1590658268037-6f5947c66576", ratings: 4.5, commentsCount: 120, createdAt: d(150) },
    { id: "prod-103", name: "UltraBook Pro 15\"", description: "Lightweight powerhouse for professionals. i9 processor, 32GB RAM, 1TB SSD. Built for heavy multitasking.", price: 2199.50, originalPrice: 2499.00, discount: 299.5, stockQuantity: 25, isActive: true, categoryId: "cat-elec", subcategoryId: "sub-laptops", storeId: "store-tech", thumbnail: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853", ratings: 4.9, commentsCount: 8, createdAt: d(80) },
    { id: "prod-201", name: "Classic Denim Jacket", description: "Vintage wash denim jacket with a relaxed fit. Perfect for layering in any season.", price: 89.00, originalPrice: 89.00, discount: 0, stockQuantity: 0, isActive: true, categoryId: "cat-fash", subcategoryId: "sub-shirts", storeId: "store-fash", thumbnail: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531", ratings: 4.2, commentsCount: 15, createdAt: d(200) }, // Out of stock
    { id: "prod-202", name: "Urban Runner Sneakers", description: "Breathable mesh upper with high-rebound cushioning. Designed for city running and casual wear.", price: 120.00, originalPrice: 150.00, discount: 30, stockQuantity: 85, isActive: true, categoryId: "cat-fash", subcategoryId: "sub-shoes", storeId: "store-fash", thumbnail: "https://images.unsplash.com/photo-1542291026-7eec264c27ff", ratings: 4.6, commentsCount: 60, createdAt: d(45) },
    { id: "prod-203", name: "Organic Cotton T-Shirt 3-Pack", description: "Ethically sourced, 100% organic cotton basic tees. Includes black, white, and grey.", price: 45.00, originalPrice: 60.00, discount: 15, stockQuantity: 200, isActive: true, categoryId: "cat-fash", subcategoryId: "sub-shirts", storeId: "store-fash", thumbnail: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab", ratings: 4.7, commentsCount: 33, createdAt: d(300) },
    { id: "prod-301", name: "Modern Ceramic Vase", description: "Minimalist ceramic vase, perfect for dried flowers or as a standalone centerpiece.", price: 35.50, originalPrice: 35.50, discount: 0, stockQuantity: 40, isActive: false, categoryId: "cat-home", storeId: "store-home", thumbnail: "https://images.unsplash.com/photo-1581783342308-f792dbdd27c5", ratings: 4.0, commentsCount: 2, createdAt: d(120) } // Inactive product
  ] as IProductModel[],
