...
export const handleFetchSubCategories = async (req: CustomRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const handleCreateSubCategory = async (req: CustomRequest, res: Response, next: NextFunction): Promise<void> => {
...
export const handleUpdateSubCategory = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const handleDeleteSubCategory = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  const id = req.params.id;
