...
export const handleCreateRole = async (req: CustomRequest, res: Response, next: NextFunction): Promise<void> => {
  const { name } = req.body;
...
export const handleDeleteRole = async (req: CustomRequest, res: Response, next: NextFunction): Promise<void> => {
...
export const handleUpdateRole = async (req: CustomRequest, res: Response, next: NextFunction): Promise<void> => {
  const id = req.params.id;
  const { name } = req.body;
  const userId = req.UserId;
